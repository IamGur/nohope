...
try {
  if (command === "ping") {
   ...
   /*if (command === "playtest") {
    ...
    message.channel.send("Your song of choice is on the queue. ${args[0]}")
...
if (command === 'botinfo' || command === 'info') {
    let embed = new Discord.RichEmbed()
        ...
        .addField('Online Users', `${guilds.members.filter(o => o.presence.status === 'online').size}`, inline = true)
